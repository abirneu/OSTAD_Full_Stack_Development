...
class Category(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)#jokhon create korbo tokhon e time pick korbe r change hobe na
    updated_at = models.DateTimeField(auto_now=True)#update korle change hobe 
